...
<template>
    ...
    <AuthenticationCard>
        ...
        <form class="mt-4 space-y-6 sm:mt-6" @submit.prevent="submit">
            ...
            <div class="space-y-3">
                ...
                <button disabled
                    ...
                    {{ t('auth.login.sign_in_with_apple') }}
                </button>
            </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                        <span class="text-sm text-gray-600 ms-2 dark:text-gray-400">{{ t('auth.login.remember_me')
                            }}</span>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                    {{ t('auth.login.title_description')
                    }}
